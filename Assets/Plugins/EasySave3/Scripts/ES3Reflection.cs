...
using UnityEngine;
using ES3Types;
using NepixSDK.NepixCore.Plugins.EasySave3;
...
namespace ES3Internal
{
    public static class ES3Reflection
    {
        ...
        public static Type GetType(string typeString)
        {
            ...
            if (NepixES3.TryGetAliasType(typeString, out Type type))
                return type;
        ...
        public static string GetTypeString(Type type)
        {
            ...
            else if (NepixES3.TryGetAliasTypeString(type, out string typeSting))
                return typeSting;
            else
